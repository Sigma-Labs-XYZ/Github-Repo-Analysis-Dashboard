...
- `code_quality_analyzer.py`: CodeQualityAnalyzer uses radon for static analysis
- `repo_content_analyzer.py`: RepoContentAnalyzer analyzes language breakdown and file structure
